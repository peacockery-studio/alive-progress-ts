...
describe("built-in spinners", () => {
  ...
  test("all spinners are functions", () => {
    for (const [_name, spinner] of Object.entries(spinners)) {
  ...
  test("all spinners produce valid frames", () => {
    for (const [_name, factory] of Object.entries(spinners)) {
...
describe("built-in bars", () => {
  ...
  test("all bars are functions", () => {
    for (const [_name, bar] of Object.entries(bars)) {
  ...
  test("all bars produce valid frames", () => {
    for (const [_name, factory] of Object.entries(bars)) {
