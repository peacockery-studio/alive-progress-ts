...
describe("calculateRefreshInterval", () => {
  ...
  test("higher rate gives shorter interval", () => {
    ...
    const fastInterval = calculateRefreshInterval(100_000);
...
describe("calibrationInfo", () => {
  test("returns FPS values for various rates", () => {
    ...
    expect(info[10_000]).toBeDefined();
    expect(info[100_000]).toBeDefined();
    expect(info[1_000_000]).toBeDefined();
    expect(info[10_000_000]).toBeDefined();
  });
  ...
  test("respects calibration parameter", () => {
    ...
    const info2 = calibrationInfo(1_000_000);
